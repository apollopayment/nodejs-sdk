...
export default class BlockchainAddressRequest extends BaseClass {
  searchById(id: string): ApolloAPIReturnType {
  ...
  addTrackingAddress(address: string, webhookUrl: string): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  searchByAddress(address: string): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  setMetaData(id: string, meta: Object | String | null): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  getAddressTransactions(req: TBlockchainTrxByAddressFilter): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  getListOfPayInAddresses(advancedBalanceId: string): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  getListOfBusinessAddresses(advancedBalanceId: string): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
      const data: DataBuilder = new DataBuilder({ advancedBalanceId });
      this.headerBuilder.setData(data);
  ...
  getListOfRecurrentAddresses(advancedBalanceId: string): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
      const data: DataBuilder = new DataBuilder({ advancedBalanceId });
      this.headerBuilder.setData(data);
  ...
  getListOfPayOutAddresses(advancedBalanceId: string): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
      const data: DataBuilder = new DataBuilder({ advancedBalanceId });
      this.headerBuilder.setData(data);
  ...
  createBusinessWalletAddress(req: TBusinessWalletAddress): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
      const data: DataBuilder = new DataBuilder(req);
      this.headerBuilder.setData(data);
  ...
  createPayOutWalletAddress(currency: string, network: string): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
