...
export default class PartnersAPIRequest extends BaseClass {
  ...
  createUser(email: string): ApolloAPIReturnType {
  ...
  getUser(userId: string): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  getUsers(req: TPagination): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  createOrganization(userId: string, name: string): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  getOrganizations(req: TPartnersAPIOrganizationListRequest): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
      const data: DataBuilder = new DataBuilder(req);
      this.headerBuilder.setData(data);
  ...
  getUserBalances(userId: string): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  replenishmentOfUserBalance(req: TPartnersAPIReplenishmentOfUserBalanceRequest): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
      const data: DataBuilder = new DataBuilder(req);
      this.headerBuilder.setData(data);
  ...
  getGeneralTariffs(): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  saveIndividualTariff(req: TPartnersAPIIndividualTariffEntityRequest): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
      const data: DataBuilder = new DataBuilder(req);
      this.headerBuilder.setData(data);
  ...
  getIndividualTariffs(userId: TNullableString = null, organizationId: TNullableString = null): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  createAPIkey(req: TPartnersAPIKeyRequest): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
      const data: DataBuilder = new DataBuilder(req);
      this.headerBuilder.setData(data);
  ...
  getAPIkeys(req: TPartnersAPIKeyListRequest): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
      const data: DataBuilder = new DataBuilder(req);
      this.headerBuilder.setData(data);
  ...
  deleteAPIkeys(req: TPartnersAPIKeyDeleteRequest): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
      const data: DataBuilder = new DataBuilder(req);
      this.headerBuilder.setData(data);
