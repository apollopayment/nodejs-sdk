...
export default class CrosschainSwapRequest extends BaseClass {
  ...
  getCrosschainExchangeLimits(): ApolloAPIReturnType {
  ...
  getCrosschainExchangeInfo(id: string): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  getCrosschainExchangeCommissionToken(req: TCrosschainExchangeCommissionToken): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
  ...
  createCrosschainExchange(req: TCrosschainExchangeRequest): ApolloAPIReturnType {
    return this.exceptionWrapper(async () => {
      const data: DataBuilder = new DataBuilder(req);
      this.headerBuilder.setData(data);
