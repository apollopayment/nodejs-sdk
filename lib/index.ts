...
import {ApolloResponse} from "./types/response";

const PRODUCTION_URL: string = 'https://app.apollopayment.io/api-gateway';
...
export class ApolloPayment {
  ...
  async makeRequest<T = any>(url: string, body: any = {}): ApolloResponse<T> {
